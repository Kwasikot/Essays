...
- [Multi-Scenario Foresight Architecture](../multi-scenario-foresight-architecture/multi-scenario-foresight-architecture.md) - adds early-warning, scenario steering, and continuity triggers before collapse.
