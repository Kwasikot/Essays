...
- [Multi-Scenario Foresight Architecture](../multi-scenario-foresight-architecture/multi-scenario-foresight-architecture.md) - turns explicit uncertainty into a full scenario-steering architecture.
